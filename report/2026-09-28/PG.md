...
- **均线排列**：均线纠缠 — 现价距 20 日 146.00（+0.2%）、50 日 145.86（+0.3%）、200 日 146.02（+0.1%）
- **形态结构**：下降结构 — 更低的高点 + 更低的低点；前高 148.36 → 148.23（-0.1%）、前低 142.50 → 141.86（-0.4%）
- **动能**：RSI(14) 51，中性；季线仍为负（-1.1%）但近一月已转正（+0.8%），属于反弹初期而非既成趋势
- **波动**：日均真实波幅约为价格的 1.5%；按本报告 2 ATR 的止损惯例，一个 R 相当于 3.0% 的价格距离
- **位置**：距 52 周高点 -11.2%，距 52 周低点 +8.3%
- **量能**：最新一日成交量为 20 日均量的 0.6 倍，量能正常
- **相对强度**：近一月跑输 标普500 0.1 个百分点
...
- **卖方预期**：23 位分析师覆盖；平均评级「买入」（2.20/5，1 为最看多）；目标价均值 160.61（较现价 +9.8%），区间 143.00–186.00。分析师目标价是共识而不是预测，且随价格一起移动——它更适合用来看分歧有多大（区间宽度），而不是用来当目标位。
...
| 2026-09-22 | 147.42 | 148.25 | 146.95 | **148.22** | +1.5% | 5,636,100 |
| 2026-09-23 | 147.87 | 148.93 | 147.14 | **147.39** | -0.6% | 6,580,200 |
| 2026-09-24 | 147.74 | 149.20 | 145.68 | **145.68** | -1.2% | 7,428,400 |
| 2026-09-25 | 145.97 | 146.40 | 145.33 | **146.23** | +0.4% | 5,275,382 |
